...
// Hash: 35bdb60b5b6157e70d9e19955ba6308bce83263d0556f59d1f0682ef8d8cd230
...
func (t *VersionedBlindedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	if offset1 != 28 {
		return sszutils.ErrorWithPath(sszutils.ErrFirstOffsetMismatchFn(offset1, 28), "Bellatrix:o")
	}
