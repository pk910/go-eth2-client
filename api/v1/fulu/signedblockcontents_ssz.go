...
// Hash: 71dc05ea6fae38769d9d86bd4a0f3d274eab94a668dd2625aae136ac146cb531
// Version: 0.1.3
package fulu
...
func (s *SignedBlockContents) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if s.SignedBlock == nil {
		s.SignedBlock = new(electra.SignedBeaconBlock)
	}
	...
	if size := len(s.KZGProofs); size > 33554432 {
		err = ssz.ErrListTooBigFn("SignedBlockContents.KZGProofs", size, 33554432)
		return
	}
