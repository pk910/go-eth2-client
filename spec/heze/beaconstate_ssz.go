...
// Hash: 04c3b4c1e27d28cd1fc29b77de8fc1489ac85345e9477634412b6c5a978b03a9
...
func (t *BeaconState) UnmarshalSSZ(buf []byte) (err error) {
	...
	{ // Field #41 'BuilderPendingPayments' (static)
		...
		for i := range 64 {
			if val6[i] == nil {
				val6[i] = new(gloas.BuilderPendingPayment)
			}
			buf := buf[44*i : 44*(i+1)]
	...
	{ // Field #42 'BuilderPendingWithdrawals' (dynamic)
		...
		for i := range itemCount {
			if val19[i] == nil {
				val19[i] = new(gloas.BuilderPendingWithdrawal)
			}
			buf := buf[36*i : 36*(i+1)]
