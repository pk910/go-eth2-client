...
// Hash: 898c5b1d2d42bf90b0e73833a61e31758f0a5518c33db0d902a75cab412df282
...
func (t *ExecutionPayloadEnvelope) UnmarshalSSZ(buf []byte) (err error) {
	...
	if offset0 != 56 {
		return sszutils.ErrorWithPath(sszutils.ErrFirstOffsetMismatchFn(offset0, 56), "Payload:o")
	}
