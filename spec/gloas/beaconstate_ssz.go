...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	for ii := 0; ii < 64; ii++ {
		dst = ssz.MarshalUint64(dst, uint64(b.ProposerLookahead[ii]))
	}
	...
	if size := len(b.ExecutionPayloadAvailability); size != 1024 {
		err = ssz.ErrVectorLengthFn("BeaconState.ExecutionPayloadAvailability", size, 1024)
		return
	}
	for ii := 0; ii < 1024; ii++ {
		dst = ssz.MarshalUint8(dst, b.ExecutionPayloadAvailability[ii])
	}
	...
	if size := len(b.PayloadExpectedWithdrawals); size != 16 {
		err = ssz.ErrVectorLengthFn("BeaconState.PayloadExpectedWithdrawals", size, 16)
		return
	}
	for ii := 0; ii < 16; ii++ {
	...
	if size := len(b.BuilderPendingWithdrawals); size > 1048576 {
		err = ssz.ErrListTooBigFn("BeaconState.BuilderPendingWithdrawals", size, 1048576)
		return
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = capella.WithdrawalIndex(ssz.UnmarshallUint64(buf[2736849:2736857]))

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[2736857:2736865]))
	...
	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736877:2736885]))

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736885:2736893]))

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = phase0.Epoch(ssz.UnmarshallUint64(buf[2736893:2736901]))

	// Field (32) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736901:2736909]))

	// Field (33) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = phase0.Epoch(ssz.UnmarshallUint64(buf[2736909:2736917]))
	...
	// Field (37) 'ProposerLookahead'
	b.ProposerLookahead = make([]phase0.ValidatorIndex, 64)
	for ii := 0; ii < 64; ii++ {
		b.ProposerLookahead[ii] = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[2736929:2737441][ii*8 : (ii+1)*8]))
	}
	...
	// Field (39) 'NextWithdrawalBuilderIndex'
	b.NextWithdrawalBuilderIndex = BuilderIndex(ssz.UnmarshallUint64(buf[2737445:2737453]))

	// Field (40) 'ExecutionPayloadAvailability'
	b.ExecutionPayloadAvailability = ssz.ExtendUint8(b.ExecutionPayloadAvailability, 1024)
	for ii := 0; ii < 1024; ii++ {
		b.ExecutionPayloadAvailability[ii] = ssz.UnmarshallUint8(buf[2737453:2738477][ii*1 : (ii+1)*1])
	}
	...
	// Field (43) 'LatestBlockHash'
	copy(b.LatestBlockHash[:], buf[2741297:2741329])

	// Field (44) 'PayloadExpectedWithdrawals'
	b.PayloadExpectedWithdrawals = make([]*capella.Withdrawal, 16)
	for ii := 0; ii < 16; ii++ {
		if b.PayloadExpectedWithdrawals[ii] == nil {
			b.PayloadExpectedWithdrawals[ii] = new(capella.Withdrawal)
		}
		if err = b.PayloadExpectedWithdrawals[ii].UnmarshalSSZ(buf[2741329:2742033][ii*44 : (ii+1)*44]); err != nil {
			return err
		}
	}
	...
	// Field (34) 'PendingDeposits'
	{
		...
		b.PendingDeposits = make([]*electra.PendingDeposit, num)
		for ii := 0; ii < num; ii++ {
			if b.PendingDeposits[ii] == nil {
				b.PendingDeposits[ii] = new(electra.PendingDeposit)
			}
	...
	// Field (35) 'PendingPartialWithdrawals'
	{
		...
		b.PendingPartialWithdrawals = make([]*electra.PendingPartialWithdrawal, num)
		for ii := 0; ii < num; ii++ {
			if b.PendingPartialWithdrawals[ii] == nil {
				b.PendingPartialWithdrawals[ii] = new(electra.PendingPartialWithdrawal)
			}
	...
	// Field (36) 'PendingConsolidations'
	{
		...
		b.PendingConsolidations = make([]*electra.PendingConsolidation, num)
		for ii := 0; ii < num; ii++ {
			if b.PendingConsolidations[ii] == nil {
				b.PendingConsolidations[ii] = new(electra.PendingConsolidation)
			}
...
func (b *BeaconState) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (40) 'ExecutionPayloadAvailability'
	{
		...
		subIndx := hh.Index()
		for _, i := range b.ExecutionPayloadAvailability {
			hh.AppendUint8(i)
		}
		hh.Merkleize(subIndx)
	}
	...
	{
		subIndx := hh.Index()
		num := uint64(len(b.BuilderPendingPayments))
		if num > 0 {
			err = ssz.ErrIncorrectListSize
			return
		}
